...
beer4 = Beer.create!(name: "Double Negative", brewery_id: grimm.id, style: "Sour", abv: "10")
beer5 = Beer.create!(name: "Lambo Door", brewery_id: grimm.id, style: "IPA", abv: "8")
beer6 = Beer.create!(name: "Rainbow Dome", brewery_id: grimm.id, style: "Sour", abv: "5")
