...
# beer16 = Beer.create(name: "Pale Ale", brewery_id: sierra_nevada.id, style: "Pale Ale", abv: "")
...
# beer24 = Beer.create(name: "Super Session #8", brewery_id: lawsons.id, style: "", abv: "4.8")
...
# beer54 = Beer.create(name: "Pils", brewery_id: augustiner.id, style: "Pilsner", abv: "5.6")
# beer55 = Beer.create(name: "Lagunitas Sucks", brewery_id: lagunitas.id, style: "IPA", abv: "8")
# beer56 = Beer.create(name: "Hop Stoopid", brewery_id: lagunitas.id, style: "IPA", abv: "8")
# beer57 = Beer.create(name: "Pils", brewery_id: lagunitas.id, style: "Pilsner", abv: "6")
# beer58 = Beer.create(name: "Hoponius Union", brewery_id: jacks_abbey.id, style: "IPL", abv: "6.5")
# beer59 = Beer.create(name: "Kiwi Rising", brewery_id: jacks_abbey.id, style: "IPL", abv: "8.5")
# beer60 = Beer.create(name: "House Lager", brewery_id: jacks_abbey.id, style: "Helles Lager", abv: "5.2")